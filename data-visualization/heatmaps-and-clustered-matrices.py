...
# Since the number of flights increase every year, we should set a
# standard scale
# standardize by columns (year)
...
# This subtracts the mean and devides by the STD of each column, then teh
# rows have amean of 0 and a variance of 1
