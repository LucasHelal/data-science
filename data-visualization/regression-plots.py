...
# Then we see a linear regression line, which is an estimateed linear fit
# model to the data
...
# Just like before, we can use dictionaries to edit individual parts of
# the plot
...
# The lmplot() we've been using is actually using a lower-level function,
# regplot()

sns.regplot("total_bill", "tip_pect", tips)

# reg_plot can be added to existing axes without modifying anything in the
# figure
