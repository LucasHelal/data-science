...
# Notice how the previous plot had outlier points, we can include those
# with the "whiskers"
...
# Violin/Viola plots can combine the simplicity of a box plot with the
# information of a kde plot
...
# We can also change the bandwidth of the kernel used for the density fit
# of the violin plots if desired
