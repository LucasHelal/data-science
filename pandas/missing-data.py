...
# Now we'll learn how to deal with missing data, a very common task when
# analyzing datasets!
...
dframe = DataFrame([[1, 2, 3], [np.nan, 5, 6], [
...
dframe2 = DataFrame([[1, 2, 3, np.nan], [2, np.nan, 5, 6], [
                    np.nan, 7, np.nan, 9], [1, np.nan, np.nan, np.nan]])
# Drop any rows tht dont have at least 2 data points
dframe2.dropna(thresh=2)
# Drop rows without at least 3 data points
